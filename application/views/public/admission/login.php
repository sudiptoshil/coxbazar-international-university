	...
	<div class="container">
		<div class="alumni-login-box">
			<div class="alumni-login-wrapper">
				<h1 class="login-title text-center">Applicant Login </h1>

				<form action="<?php echo base_url(); ?>home/auth" method="post" class="form-signin">
					<div class="form-group form-focus">
						<!-- <label class="control-label">Roll</label> -->
						<input name="email" class="form-control floating" type="email" placeholder="email" required autofocus>
					</div>
					<div class="form-group form-focus">
					...
					<div class="text-center">
						<a href="<?php echo base_url(); ?>student/StudentRegister/student_register">Register</a>
					</div>
					<div class="text-center">
