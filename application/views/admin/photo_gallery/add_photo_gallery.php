...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="<?=base_url('admin/photo_gallery_entry')?>" method="post" enctype="multipart/form-data">
                    <div class="card-box">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <a href="<?=base_url('admin/photo_gallery/')?>" class="btn btn-primary">All Images</a>

                            </div>
                        </div>
                        <div class="row rr">
                            <div class="col-md-8 col-md-offset-2" >
                                <input type="hidden" value="<?php if(!empty($info)) echo $info->id;?>" name="gallery_image_id" id="gallery_image_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" id="image-holder">
                                        <?php if(!empty($info->image)):?>
                                            <img src="<?=base_url('assets/images/photo_gallery/').$info->image?>" width="200" height="100">
                                        <?php endif;?>
                                    </div>
                                </div>
