...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="row">
            ...
            <?php if($success == 1){?>
            <script>
            	alert("Muktijuddha Corner Content Successfully Inserted.");
            </script>
        	<?php }?>
            ...
            <div class="card-box">
            	<div class="notice-form">
	                <h2 class="text-center"><?php if(!empty($info)):?>
                        ...
                        <?php else:?>
                            Add New
                        <?php endif;?> Muktijuddha Corner Content</h2>
	                <br>
					<?php echo validation_errors(); ?>

					<?php echo form_open_multipart('admin/new_muktijuddha_corner_content_insert','class="form-horizontal"'); ?>
                    <input type="hidden" name="event_id" value="<?php if(!empty($info)){echo $info->id;}?>">
	                    ...
	                    <div class="form-group">
	                        <label class="control-label col-lg-2">Image/MP4/MP3 File</label>
	                        <div class="col-lg-5">
