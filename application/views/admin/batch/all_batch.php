            ...
            <div class="card-box">
                <div class="all-slider_image">
                    <div class="content container-fluid">
                        <div class="row">
                            <div class="col-xs-9">
                                <h4 class="page-title col-xs-4 ">All batch</h4>
                            ...
                            <div class="col-xs-3 text-right">
                                <a href="<?=base_url('admin/add_batch/')?>" class="btn btn-primary">Add Batch</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                            ...
                                            <?php if(!empty($info)): 
                                                ...
                                                $sl=1; foreach($info as $val):?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td><?=$val['name'];?></td>
                                                        <td width="200px;">
                                                            <a href="<?= base_url() ?>admin/add_batch/?id=<?=$val['id'];?>"
                                                               class="btn btn-warning"><i class="fa fa-pencil"></i> Update</a>
                                                            <a onclick="return(confirm('Are You Sure?'))"
                                                               href="<?= base_url() ?>admin/delete_batch/<?=$val['id'];?>"
