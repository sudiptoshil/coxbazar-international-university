            ...
            <div class="card-box">
                <div class="all-slider_image">
                    <div class="content container-fluid">
                        <div class="row">
                            <div class="col-xs-9">
                                <h4 class="page-title col-xs-4 ">All Important Links</h4>
                            ...
                            <div class="col-xs-3 text-right">
                                <a href="<?=base_url('admin/add_important_link/')?>" class="btn btn-primary">Add Important Link</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                            ...
                                            <?php if(!empty($info)): 
                                                ...
                                                $sl=1; foreach($info as $val):?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?php if($val['status']==1):?>
                                                                <a href="<?=base_url('admin/link_change_status/').$val['id'].'/'.$val['status'];?>"
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url() ?>admin/add_important_link/?id=<?=$val['id'];?>"
                                                               class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                                                            <a onclick="return(confirm('Are You Sure?'))"
                                                               href="<?= base_url() ?>admin/delete_important_link/<?=$val['id'];?>"
