...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="row">
            ...
            <?php if($success == 1){?>
            <script>
            	alert("Mujib Borsho Content Successfully Inserted.");
            </script>
        	<?php }?>
            ...
            <div class="card-box">
            	<div class="notice-form">
	                <h2 class="text-center"><?php if(!empty($info)):?>
                        ...
                        <?php else:?>
                            Add New
                        <?php endif;?> Mujib Borsho Content</h2>
	                <br>
					<?php echo validation_errors(); ?>

					<?php echo form_open_multipart('admin/new_mujib_borsho_content_insert','class="form-horizontal"'); ?>
