                    ...
                    <div class="content container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-3 text-right">
                                <a href="<?=base_url('admin/add_administration_list/')?>" class="btn btn-primary">Add administration list</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                            ...
                                            <?php if(!empty($info)): 
                                                ...
                                                $sl=1; foreach($info as $val):?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td width="200px;">
                                                            <a href="<?= base_url() ?>admin/add_administration_list/?id=<?=$val['id'];?>"
                                                               class="btn btn-warning"><i class="fa fa-pencil"></i> Update</a>
                                                            <a onclick="return(confirm('Are You Sure?'))"
                                                               href="<?= base_url() ?>admin/delete_administration_list/<?=$val['id'];?>"
