            ...
            <div class="card-box">
            	<div class="wrapper-body">
		            <div class="content container-fluid">
		                <div class="row">
		                    <div class="col-xs-12">
		                        <h4 class="page-title">Hostel Seat Request</h4>
		                    </div>
		                </div>
		                <div class="row">
		                    <div class="col-lg-12">
		                            ...
		                            <div class="card-block">
		                                <table id="table_all_data" class="display w-100 dataTable table-bordered table table-stripped all_teacher">
		                                    ...
		                                    <tbody>
		                                        <?php
		                                        $sl = 1;
		                                        foreach ($all_req_for_hostel as $key => $t) {
		                                        ?>
		                                        <tr>
		                                            <td class="text-center"><?php echo $sl;?></td>
		                                            <td class="text-nowrap text-center"><?php echo $t['date'];?></td>
		                                            <td class="text-nowrap text-center"><?php echo $t['student_name'];?></td>
		                                            <td class="text-nowrap text-center"><?php if($t['gender'] == 1){echo "Male";}elseif($t['gender'] == 2){echo "Female";}?></td>
		                                            <td class="text-nowrap text-center"><!--<a href="<?=base_url();?>admin/user_profile/<?=$this->common->getSpecificField('students','roll',$t['roll'],'id')?>/<?=$this->common->get_user_type('student');?>" target="_blank"><?php echo $t['roll'];?></a>--><?php echo $t['roll'];?></td>
		                                            <!--<td class="text-nowrap text-center"><?php echo $t['hostel_name'];?></td>-->
		                                            ...
		                                            <td class="text-center"><?php echo $t['application'];?></td>
