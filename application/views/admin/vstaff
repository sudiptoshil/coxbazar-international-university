            ...
            <div class="card-box">
                <div class="all-slider_image">
                    <div class="content container-fluid">
                        <div class="row">
                            <div class="col-xs-9">
                                <h4 class="page-title col-xs-4 ">All files for link</h4>
                            ...
                            <div class="col-xs-3 text-right">
                                <a role="button" data-toggle="collapse" href="#add_admission_file" aria-expanded="false" aria-controls="add_admission_file" class="btn btn-primary">Add File</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="collapse <?php if(isset($_GET['file_id'])){echo 'in';}?>" id="add_admission_file">
                                    <div class="well">
                                        <form action="<?=base_url('admin/add_upload_file_for_link')?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-4" >
