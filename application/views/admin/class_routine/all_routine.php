            ...
            <div class="card-box">
                <div class="all-slider_image">
                    <div class="content container-fluid">
                        <div class="row">
                            <div class="col-xs-9">
                                <h4 class="page-title col-xs-4 ">All Routine</h4>
                            ...
                            <div class="col-xs-3 text-right">
                                <a href="<?=base_url('admin/add_routine/')?>" class="btn btn-primary">Add routine</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?php if(!empty($val['file_name'])):?>
                                                              <iframe src="<?=base_url('assets/doc/class_routine/').$val['file_name']?>" style="width:100%;height:100px;"></iframe>

                                                                <!--<img src="<?=base_url('assets/doc/class_routine/').$val['file_name']?>" width="100" height="100">-->
                                                            <?php endif;?>
                                                        </td>
                                                        <td><?=date('d-m-Y h:i a',strtotime($val['date_time']));?></td>
                                                        <td>
                                                            <?php if($val['status']==1):?>
                                                                <a href="<?=base_url('admin/routine_change_status/').$val['id'].'/'.$val['status'];?>"
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url() ?>admin/add_routine/?id=<?=$val['id'];?>"
                                                               class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                                                            <a onclick="return(confirm('Are You Sure?'))"
                                                               href="<?= base_url() ?>admin/delete_routine/<?=$val['id'];?>"
