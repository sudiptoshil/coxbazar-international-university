...
<form method="get" action="<?php echo base_url();?>main/member">
<table align="center">
...
<td>
<?php if($item['status']==1) { ?>
<a href="<?php echo base_url(); ?>main/active/<?php echo $item['id']?>/0">
 <img src="<?php echo base_url(); ?>img/stock_lock_open.png" class="logo2" alt="Logo"/>
</a>
<?php } else { ?>
<a href="<?php echo base_url(); ?>main/active/<?php echo $item['id']?>/1">
