...
<label class="col-sm-3 control-label">Type</label></div>	</td>
<td>	
<select class="form-control input-lg m-bot15" name="type">
<option value="1">Store In</option>
<option value="2">In Return</option>
<option value="3">Store Out</option>
<option value="4">Out Return</option>
</select></td>
...
<td><a target="_blank" href="<?php echo base_url(); ?>admin/invoice/<?=$item['id']?>"><?=$item['invoice_no']?></a></td>
<td><a target="_blank" href="<?php echo base_url(); ?>admin/chalan/<?=$item['id']?>"><?=$item['invoice_no']?></a></td>
...
?></td>
<td>
<a target="_blank" class="menu" href="<?php echo base_url(); ?>admin/invoice_edit/<?=$item['id']?>">EDIT</a>
</td>
<td><?php
