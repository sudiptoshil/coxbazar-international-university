...
<form method="get" action="<?php echo base_url();?>admin/order/">
<table align="center">
<tr>
...
<td><a target="_blank" class="menu" href="<?php echo base_url(); ?>admin/create_bill/<?php echo $item['id']?>">Create Bill</a></td>	
<td><a target="_blank" class="menu" href="<?php echo base_url(); ?>admin/invoice/<?php echo $item['id']?>">Invoice</a></td>
</tr>
